...
class XEntLoss(torch.nn.Module):
    ...
    def forward(self, y_pred, y_true, kernel_bw):
        ...
        ******************************************************************
            *  Func:      XEntLoss()
            *  Desc:      Computes empirical estimate of minimum cross entropy error.
            *  Inputs:    
            *             y_pred - vector of predicted labels [nx10]
            *             y_true - vector of true labes [nx10]
            *             parameters - dictionary of script parameters
            *                          must include mee kernel bandwidth
            *  Outputs:   
            *             xent_loss_val: scalar of estimated mee loss
        ******************************************************************
        """
